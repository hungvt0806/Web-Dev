...
const AddFood = () => {
    ...
    const onSubmitHandler = async (event) => {
        ...
        if(!image){
            toast.alert('Please select an image.');
            return;
        }
   try {
      ...
      <div className="card-body">
        ...
        <form onSubmit={onSubmitHandler}>
          ...
          <div className="mb-3">
            ...
            <input type="number" className="form-control" id="price" placeholder='&#8377;200' name='price' onChange={onChangeHandler} value={data.price}/>
          </div>
