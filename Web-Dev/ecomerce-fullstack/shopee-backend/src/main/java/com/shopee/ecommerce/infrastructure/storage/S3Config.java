...
public class S3Config {
    ...
    /** Optional: override endpoint for LocalStack / MinIO testing. */
    ...
    public S3Client s3Client() {
        ...
        if (!accessKey.isBlank()) {
            ...
            log.info("S3 using static credentials (access-key configured)");
        } else {
            builder.credentialsProvider(DefaultCredentialsProvider.create());
            log.info("S3 using DefaultCredentialsProvider (IAM role / env vars)");
        }
